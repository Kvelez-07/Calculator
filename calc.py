...
def equals():
    ...
    except SyntaxError: #Avoid terminal errors when executing code
...
#Sets up the calculator pop-up window
window = Tk()
...
#Set the frame for the button and use a lambda command to get the keyboard keys
...
#Set the frame and also the command to equals
...
#Set to window and command to clear
clear = Button(window, text="clear", height=4, width=9, font=35, command=clear)
clear.pack()

window.mainloop() #Opens the calculator